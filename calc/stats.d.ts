...
export declare const Stats: {
    ...
    calcStat(gen: Generation, stat: StatID, base: number, iv: number, ev: number, level: number, av: number, friendship: number, nature?: string): number;
    ...
    calcStatLGPE(natures: Natures, stat: StatID, base: number, iv: number, av: number, level: number, friendship: number, nature?: string): number;
