...
function calculateLGPE(gen, attacker, defender, move, field) {
    var _a;
    ...
    move.type = type;
    var isGhostRevealed = field.defenderSide.isForesight;
    ...
    var basePower = calculateBasePowerLGPE(gen, attacker, defender, move, field, hasAteAbilityTypeChange, desc);
    if (basePower === 0) {
        return result;
    }
    var attack = calculateAttackLGPE(gen, attacker, defender, move, field, desc, isCritical);
    var attackStat = move.named('Shell Side Arm') &&
        ...
        : move.named('Body Press')
            ...
            : move.category === 'Special'
                ? 'spa'
                : 'atk';
    var defense = calculateDefenseLGPE(gen, attacker, defender, move, field, desc, isCritical);
    ...
    var baseDamage = calculateBaseDamageLGPE(gen, attacker, defender, basePower, attack, defense, move, field, desc, isCritical);
    ...
    var finalMods = calculateFinalModsLGPE(gen, attacker, defender, move, field, desc, isCritical, typeEffectiveness);
    var protect = false;
    ...
    if (attacker.hasAbility('Parental Bond') && move.hits === 1 && !isSpread) {
        ...
        childDamage = calculateLGPE(gen, child, defender, move, field).damage;
        desc.attackerAbility = attacker.ability;
    }
    var damage = [];
    for (var i = 0; i < 16; i++) {
    ...
    if ((move.dropsStats && move.timesUsed > 1) || move.hits > 1) {
        ...
        var _loop_1 = function (times) {
            ...
            var newAttack = calculateAttackLGPE(gen, attacker, defender, move, field, desc, isCritical);
            var newDefense = calculateDefenseLGPE(gen, attacker, defender, move, field, desc, isCritical);
            ...
            var newBasePower = calculateBasePowerLGPE(gen, attacker, defender, move, field, hasAteAbilityTypeChange, desc, times + 1);
            var newBaseDamage = calculateBaseDamageLGPE(gen, attacker, defender, newBasePower, newAttack, newDefense, move, field, desc, isCritical);
            var newFinalMods = calculateFinalModsLGPE(gen, attacker, defender, move, field, desc, isCritical, typeEffectiveness, times);
...
exports.calculateLGPE = calculateLGPE;
function calculateBasePowerLGPE(gen, attacker, defender, move, field, hasAteAbilityTypeChange, desc, hit) {
    var _a;
    if (hit === void 0) { hit = 1; }
    var turnOrder = attacker.stats.spe > defender.stats.spe ? 'first' : 'last';
    var basePower;
    ...
    var bpMods = calculateBPModsLGPE(gen, attacker, defender, move, field, desc, basePower, hasAteAbilityTypeChange, turnOrder);
...
exports.calculateBasePowerLGPE = calculateBasePowerLGPE;
function calculateBPModsLGPE(gen, attacker, defender, move, field, desc, basePower, hasAteAbilityTypeChange, turnOrder) {
    var bpMods = [];
...
exports.calculateBPModsLGPE = calculateBPModsLGPE;
function calculateAttackLGPE(gen, attacker, defender, move, field, desc, isCritical) {
    ...
    var atMods = calculateAtModsLGPE(gen, attacker, defender, move, field, desc);
    attack = (0, util_2.OF16)(Math.max(1, (0, util_2.pokeRound)((attack * (0, util_2.chainMods)(atMods, 410, 131072)) / 4096)));
    return attack;
}
exports.calculateAttackLGPE = calculateAttackLGPE;
function calculateAtModsLGPE(gen, attacker, defender, move, field, desc) {
    var atMods = [];
...
exports.calculateAtModsLGPE = calculateAtModsLGPE;
function calculateDefenseLGPE(gen, attacker, defender, move, field, desc, isCritical) {
    if (isCritical === void 0) { isCritical = false; }
    var defense;
    var hitsPhysical = move.overrideDefensiveStat === 'def' || move.category === 'Physical' ||
        (move.named('Shell Side Arm') && (0, util_2.getShellSideArmCategory)(attacker, defender) === 'Physical');
    ...
    var dfMods = calculateDfModsLGPE(gen, attacker, defender, move, field, desc, isCritical, hitsPhysical);
    return (0, util_2.OF16)(Math.max(1, (0, util_2.pokeRound)((defense * (0, util_2.chainMods)(dfMods, 410, 131072)) / 4096)));
}
exports.calculateDefenseLGPE = calculateDefenseLGPE;
function calculateDfModsLGPE(gen, attacker, defender, move, field, desc, isCritical, hitsPhysical) {
    var _a;
    if (isCritical === void 0) { isCritical = false; }
...
exports.calculateDfModsLGPE = calculateDfModsLGPE;
function calculateBaseDamageLGPE(gen, attacker, defender, basePower, attack, defense, move, field, desc, isCritical) {
    if (isCritical === void 0) { isCritical = false; }
...
function calculateFinalModsLGPE(gen, attacker, defender, move, field, desc, isCritical, typeEffectiveness, hitCount) {
    if (isCritical === void 0) { isCritical = false; }
...
exports.calculateFinalModsLGPE = calculateFinalModsLGPE;
